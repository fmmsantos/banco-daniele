...
public class TestBanco {
	...
	public void resultadoBanco() {
		...
		Assert.assertEquals("O numero do documento � ","1235",output.get(2).getNrDocumento());
		Assert.assertEquals("O valor do documento � ",new BigDecimal("600"),output.get(2).getValor());
